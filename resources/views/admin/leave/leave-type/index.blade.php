        ...
        <div class="modal fade" id="addValueModal" tabindex="-1" aria-labelledby="addModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    {{ Form::open(['url' => route('leave-type.store'), 'class' => 'row g-3 needs-validation', 'novalidate' => true]) }}
                    <div class="modal-body">
                        {{ Form::label('title', 'Name : *', ['class' => 'form-label']) }}
                        {{ Form::text('title', @$old_info->title, ['class' => 'form-control', 'required' => true]) }}
                        {{ Form::label('days', 'Granted Days : *', ['class' => 'form-label']) }}
                        {{ Form::number('days', @$old_info->days, ['class' => 'form-control', 'required' => true]) }}
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <x-delete-modal :data="$value" :route="'leave-type'"/>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
