        ...
        <div class="modal fade" id="addValueModal" tabindex="-1" aria-labelledby="addModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    {{ Form::open(['url' => route('division.store'), 'class' => 'row g-3 needs-validation', 'novalidate' => true]) }}
                    <div class="modal-body">
                        ...
                        {{ Form::select('department_id', \App\Models\Department::where('status', 1)->pluck('title', 'id'), @$old_info->department_id, ['class' => 'form-control', 'required' => true]) }}
